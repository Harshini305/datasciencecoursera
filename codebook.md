...
Analysis process
The R script, run_sript.R begins by loading the libraries that are used for this analysis:
...
Steps:
The features and activity labels for the dataset are loaded.
The training, test and subject datasets are read in and merged into one data frame.
...
The summarized dataset is written to a file, ActivityDataSummary.txt.
